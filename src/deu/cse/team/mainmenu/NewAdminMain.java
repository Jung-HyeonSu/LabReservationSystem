...
import deu.cse.team.timetable.newEditClassTimetable;
import deu.cse.team.timetable.newSeminarTimetable;
import deu.cse.team.tokenauth.TokenAuth;
import deu.cse.team.tokenauth.newTokenAuth;
 ...
 * @author PC
 */
public class NewAdminMain extends javax.swing.JFrame {
    ...
    newTokenAuth tokenAuth;
    newAdminRegister adminRegister;
    newAccountmanagement mgmtAccount;
    ReserveStatus rs;
    newReserveAuth reserveAuth;
    MBoard mboard;
    newEditClassTimetable edit;
    newSeminarTimetable seminarTimetable;
        

    public NewAdminMain() {
        initComponents();
        tokenAuth = new newTokenAuth();
        adminRegister = new newAdminRegister();
        mgmtAccount = new newAccountmanagement();
        rs = new ReserveStatus();
        reserveAuth = new newReserveAuth();
        mboard = new MBoard(jLabel3.getText(), "admin");
        edit = new newEditClassTimetable();
        seminarTimetable = new newSeminarTimetable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewAdminMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewAdminMain().setVisible(true);
            }
        });
    }
