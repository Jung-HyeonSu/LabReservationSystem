...
/**
    ...
    계정 삭제, 예약 시간 연장, 예약 승인 시 관리 권한자 설정
 *
 */
public class ClassAdmin {

    public void classAdminSet(String ok, String classadmin,String classnumber,String reser_number, String reser_date, String reser_endtime) { //ㅎ
